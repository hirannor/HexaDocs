...
public record UploadDocument(
    ...
    public static UploadDocument issue(final KnowledgeBaseId knowledgeBaseId, final String name, final String contentType) {
        return new UploadDocument(CommandId.generate(), Instant.now(), knowledgeBaseId, name, contentType);
    }
}