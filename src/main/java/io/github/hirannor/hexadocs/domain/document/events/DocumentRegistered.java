...
public record DocumentRegistered(MessageId id, DocumentId documentId, KnowledgeBaseId knowledgeBaseId, String name,
                                 Instant occurredAt) implements DomainEvent {

    public static DocumentRegistered record(final DocumentId documentId, final KnowledgeBaseId knowledgeBaseId,
                                            final String name) {
