...
public class IngestionJobStatusConverter implements AttributeConverter<JobStatusEntity, String> {

    IngestionJobStatusConverter() {
    }

    @Override
    public String convertToDatabaseColumn(final JobStatusEntity statusAttribute) {
