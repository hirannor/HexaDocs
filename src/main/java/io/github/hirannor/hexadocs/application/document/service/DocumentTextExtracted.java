...
public record DocumentTextExtracted(MessageId id, IngestionJobId ingestionJobId, DocumentId document,
                                    KnowledgeBaseId knowledgeBaseId) implements ApplicationEvent {
    public static DocumentTextExtracted record(final IngestionJobId ingestionJobId, final DocumentId document,
