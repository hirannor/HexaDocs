...
public record DocumentVectorIndexed(MessageId id, IngestionJobId ingestionJobId, DocumentId document,
    ...
    public static DocumentVectorIndexed record(final IngestionJobId ingestionJobId, final DocumentId document,
                                               final KnowledgeBaseId knowledgeBaseId, final int vectorSize) {
