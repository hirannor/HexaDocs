...
public record DocumentVectorIndexingFailed(MessageId id, IngestionJobId ingestionJobId,
                                           String error) implements ApplicationEvent {
    public static DocumentVectorIndexingFailed record(final IngestionJobId ingestionJobId, final String error) {
