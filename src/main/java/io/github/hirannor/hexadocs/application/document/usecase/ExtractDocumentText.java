...
public record ExtractDocumentText(CommandId id, IngestionJobId ingestionJobId, DocumentId documentId,
                                  KnowledgeBaseId knowledgeBaseId) implements Command {
    public static ExtractDocumentText issue(final IngestionJobId ingestionJobId, final DocumentId documentId,
