...
public record DocumentTextExtractionFailed(MessageId id, IngestionJobId ingestionJobId,
                                           String error) implements ApplicationEvent {
    public static DocumentTextExtractionFailed record(final IngestionJobId ingestionJobId, final String error) {
