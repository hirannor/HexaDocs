...
public record IndexDocument(CommandId id, IngestionJobId ingestionJobId, KnowledgeBaseId knowledgeBaseId,
                            DocumentId documentId) implements Command {
    public static IndexDocument issue(final IngestionJobId ingestionJobId, final KnowledgeBaseId knowledgeBaseId,
